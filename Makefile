...
MODEL?="openai-compatible/qwen3.5-27b:Q8_0"
...
eval:
	...
	OPENCODE_URL=http://$(ADDRESS):4096 OPENCODE_DIR=$(USER_HOME)/workspace OPENCODE_MODEL=$(MODEL) pytest evals/persona_eval.py -v -W all
.PHONY: eval
